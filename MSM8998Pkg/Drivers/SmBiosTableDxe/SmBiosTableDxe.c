...
Physical Memroy Array System Boot Information (Type 32)
  ...
  Copyright (c), 2019, Sam Pavlovic <uefi-oss-projects@samapavlovic.com>
...
CHAR8 *mBIOSInfoType0Strings[] = {"LumiaWoA authors", // Vendor String
                                  "(EDK2)", // BiosVersion String
                                  NULL, // BiosReleaseDate String
                                  NULL};
...
SMBIOS_TABLE_TYPE1 mSysInfoType1 = {
    ...
    {0x0bc52bb9,
     0x9473,
     0x4875,
     {0xbe, 0x2a, 0x39, 0x73, 0x07, 0x6c, 0x20, 0xe2}},
...
VOID SysInfoUpdateSmbiosType1(VOID)
{
  ...
  mSysInfoType1Strings[3] = GetChipSerialNumber();
...
VOID BoardInfoUpdateSmbiosType2(VOID)
{
  ...
  mBoardInfoType2Strings[3] = GetChipSerialNumber();
...
VOID EnclosureInfoUpdateSmbiosType3(VOID)
{
  ...
  mEnclosureInfoType3Strings[2] = GetChipSerialNumber();
